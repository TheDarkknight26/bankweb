...
const Result = () => {
  ...
  const fetchBankData = async () => {
    try {
      const response = await axios.get("https://bankproject-alpha.vercel.app/result", {
        params: {
  ...
  const fetchBankDataBetweenDates = async () => {
    try {
      const response = await axios.get("https://bankproject-alpha.vercel.app/resultbtwdates", {
        params: {
          bankNames: JSON.stringify(final.bankNames),
          date: JSON.stringify(final.date),
